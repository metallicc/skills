...
- **Tasktracker** — issues live as tt tasks (uses the `tt` CLI)
...
- **PRs as a request surface** — yes / no (default: no). Record the answer in `docs/agents/issue-tracker.md`. For local-markdown, Tasktracker, and other trackers, skip this question — there are no PRs.
...
- [issue-tracker-tasktracker.md](./issue-tracker-tasktracker.md) — Tasktracker issue tracker
